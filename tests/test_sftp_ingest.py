...
class TestSFTPIngest(unittest.TestCase):
    def setUp(self):
        ...
        self.pysftp_patcher = patch("tasks.sftp_ingest.pysftp.Connection", autospec=True)
    ...
    def test_get_files(self):
        ...
        self.mock_sftp_ingest.get_files.assert_called_once_with("/remote_dir", "/local_dir")
        self.assertEqual(self.sftp_ingest.get_files("/remote_dir", "/local_dir"), ["file1.csv", "file2.csv"])
